        ...
        <group ref={groupRef} position={[0, 2, z]}>
            ...
            <group ref={sotdRef} position={[0, 0.5, -0.5]}>
                ...
                <AwardButton
                    onClick={(e) => {
                        e.stopPropagation();
                        window.open('https://green-bow-the-intro.vercel.app/', '_blank');
                    }}
            ...
            <group ref={sotmRef} position={[0, 0.5, -0.2]}>
                ...
                <AwardButton
                    onClick={(e) => {
                        e.stopPropagation();
                        window.open('https://career-guidance-website-nine.vercel.app/', '_blank');
                    }}
                    texture={buttonTexture}
                    paintedTexture={buttonPaintedTexture}
                    width={buttonWidth}
            ...
            <group ref={sotyRef} position={[0, 0.5, 0]}>
                ...
                <AwardButton
                    onClick={(e) => {
                        e.stopPropagation();
                        window.open('https://they-call-me-wretched.vercel.app/', '_blank');
                    }}
                    texture={buttonTexture}
                    paintedTexture={buttonPaintedTexture}
                    width={buttonWidth}

...
const STORY_MILESTONES = [
    { id: 'intro', position: [0, 0, -15], type: 'intro', title: 'SUNIL', subtitle: '< creative developer />' },
    { id: 'awards', position: [0, 0, -55], type: 'awards', title: 'PROJECTS', subtitle: 'Green Bow • Wretched • Career Guidance' },

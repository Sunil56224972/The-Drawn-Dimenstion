    ...
    return (
        <group ref={groupRef} position={[0, -0.7, -5]}>
            ...
            <SocialBarrel
                ...
                label="LINKEDIN"
                onClick={() => window.open('https://www.linkedin.com/in/sunil-aimbot-81340839a', '_blank')}
            ...
            <SocialBarrel
                ...
                texturePath="/textures/contact/beczka.webp"
                label="EMAIL"
                onClick={() => window.open('mailto:sunilnathyogi008@gmail.com', '_self')}
                paintOnBeforeCompile={onBeforeCompile}
                paintUniforms={uniformsData}
            />
            {/* FACEBOOK */}
            <SocialBarrel
                ...
                texturePath="/textures/contact/beczka.webp"
                label="DISCORD"
                onClick={() => window.open('https://discord.com/users/1012816654532620328', '_blank')}
                paintOnBeforeCompile={onBeforeCompile}
                paintUniforms={uniformsData}
            />
            {/* INSTAGRAM */}
            <SocialBarrel
                ...
                texturePath="/textures/contact/beczka.webp"
                label="INSTAGRAM"
                onClick={() => window.open('https://www.instagram.com/kali_linux_user_/', '_blank')}
                paintOnBeforeCompile={onBeforeCompile}
                paintUniforms={uniformsData}
            />

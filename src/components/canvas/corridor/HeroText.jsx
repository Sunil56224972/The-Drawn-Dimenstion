...
const HeroText = ({ position = [0, 0.3, 0] }) => {
    ...
    // Letter positions for SUNIL split effect
    const letters = useMemo(() => [
        { char: 'S', baseX: -1.10, splitDir: -2.0, delay: 0 },
        { char: 'U', baseX: -0.55, splitDir: -1.0, delay: 0 },
        { char: 'N', baseX:  0.00, splitDir:  0.0, delay: 0 },
        { char: 'I', baseX:  0.55, splitDir:  1.0, delay: 0 },
        { char: 'L', baseX:  1.10, splitDir:  2.0, delay: 0 },
    ], []);

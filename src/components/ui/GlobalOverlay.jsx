...
const ContentCard = ({ content, isOpen, onClose, isMobile }) => {
    ...
    const cardStyle = isMobile ? {
        ...
        // DESKTOP: Karta na środku (centered)
        width: 'clamp(280px, 30vw, 450px)',
        left: '50%',
        top: '50%',
        transform: isOpen ? 'translate(-50%, -50%) rotate(1deg)' : 'translate(-50%, 100%) rotate(15deg)',
        opacity: isOpen ? 1 : 0,
        color: '#1a1a1a',
    };
    ...
    const maskStyle = (content.layout === 'certificate_grid') ? {
        ...
        // Desktop: Monitor centered
        maskImage: 'radial-gradient(circle at 50% 50%, transparent 0%, transparent 12%, black 35%)',
        WebkitMaskImage: 'radial-gradient(circle at 50% 50%, transparent 0%, transparent 12%, black 35%)'
    };
